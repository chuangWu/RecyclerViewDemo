 ...
 */
public class RecyclerStaggeredAdapter extends RecyclerView.Adapter<RecyclerStaggeredAdapter.StaggeredViewHolder> {

    private Context mContext;
    private boolean mFlag;
    int mIconsV[] = {R.drawable.p1, R.drawable.p2, R.drawable.p3, R.drawable.p4, R.drawable.p5, R.drawable.p6, R.drawable.p7, R.drawable.p9,
    ...
    int mIconsH[] = {R.drawable.h1, R.drawable.h2, R.drawable.h3, R.drawable.h4, R.drawable.h5, R.drawable.h6, R.drawable.h7, R.drawable.h9,
    ...
    public RecyclerStaggeredAdapter(Context context,boolean flag) {
        mContext = context;
        mFlag = flag;
    }
    ...
    public StaggeredViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(mFlag ? R.layout.staggered_grid_item : R.layout.staggered_grid_item_h, parent, false);
    ...
    class StaggeredViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setData(int position) {
            if (mFlag) {
                icon.setImageResource(mIconsV[position % mIconsV.length]);
            } else {
                icon.setImageResource(mIconsH[position % mIconsH.length]);
            }
